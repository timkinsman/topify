        ...
        <div className="ui inverted vertical footer segment">
            <div className="ui center aligned container">
                ...
                <div className="ui horizontal inverted small divided link list">
                    <a className="item" href="https://github.com/timkinsman/topify" target="_blank">github</a>
                    ...
                    <a className="item" href="https://www.linkedin.com/in/timothykinsman/" target="_blank">linkedin</a>
                </div>
            </div>
        </div>
    )
