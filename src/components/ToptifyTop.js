    ...
    return (
        <div style={{padding: '100px 0'}}>
            ...
            <div style={{display: 'flex', justifyContent: 'center', marginBottom: '64px'}}>
                <a className={timeRange === 'lifetime' ? null : "active"} onClick={() => setTimeRange('lifetime')} style={{margin: '0 10px 14px 10px'}}>Spotify Lifetime</a>
                <a className={timeRange === 'recent' ? null : "active"} onClick={() => setTimeRange('recent')} style={{margin: '0 10px 14px 10px'}}>Recent Listening</a>
            </div>
